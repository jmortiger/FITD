...
s8 readS8LE(u8* &ptr);
s8 readS8LE(s8* &ptr);
s8 readS8LE(char* &ptr);
s8 readS8BE(u8* &ptr);
s8 readS8BE(s8* &ptr);
s8 readS8BE(char* &ptr);
u8 readU8(u8* &ptr);
u8 readU8(s8* &ptr);
u8 readU8(char* &ptr);
u8 readU8LE(u8* &ptr);
u8 readU8LE(s8* &ptr);
u8 readU8LE(char* &ptr);
u8 readU8BE(u8* &ptr);
u8 readU8BE(s8* &ptr);
u8 readU8BE(char* &ptr);
s16 readS16(u8* &ptr);
s16 readS16(s8* &ptr);
s16 readS16(char* &ptr);
s16 readS16LE(u8* &ptr);
s16 readS16LE(s8* &ptr);
s16 readS16LE(char* &ptr);
s16 readS16BE(u8* &ptr);
s16 readS16BE(s8* &ptr);
s16 readS16BE(char* &ptr);
u16 readU16(u8* &ptr);
u16 readU16(s8* &ptr);
u16 readU16(char* &ptr);
u16 readU16LE(u8* &ptr);
u16 readU16LE(s8* &ptr);
u16 readU16LE(char* &ptr);
u16 readU16BE(u8* &ptr);
u16 readU16BE(s8* &ptr);
u16 readU16BE(char* &ptr);
s32 readS32(u8* &ptr);
s32 readS32(s8* &ptr);
s32 readS32(char* &ptr);
s32 readS32LE(u8* &ptr);
s32 readS32LE(s8* &ptr);
s32 readS32LE(char* &ptr);
s32 readS32BE(u8* &ptr);
s32 readS32BE(s8* &ptr);
s32 readS32BE(char* &ptr);
u32 readU32(u8* &ptr);
u32 readU32(s8* &ptr);
u32 readU32(char* &ptr);
u32 readU32LE(u8* &ptr);
u32 readU32LE(s8* &ptr);
u32 readU32LE(char* &ptr);
u32 readU32BE(u8* &ptr);
u32 readU32BE(s8* &ptr);
u32 readU32BE(char* &ptr);
// #region void*
