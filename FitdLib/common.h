...
FORCEINLINE u16 CORRECT_ENDIAN_U16(void *ptr)
{
#ifdef UNIX
  return (((u8*)ptr)[0]<<8)|((u8*)ptr)[1];
#else
...
FORCEINLINE s16 CORRECT_ENDIAN_S16(void *ptr)
{
  return (s16)CORRECT_ENDIAN_U16(ptr);
}

FORCEINLINE u16 MANUAL_ENDIAN_U16(void *ptr)
{
#ifdef UNIX
  return (((u8*)ptr)[1]<<8)|((u8*)ptr)[0];
#else
...
FORCEINLINE s16 MANUAL_ENDIAN_S16(void *ptr)
{
  return (s16)MANUAL_ENDIAN_U16(ptr);
}

FORCEINLINE u32 CORRECT_ENDIAN_U32(void *ptr)
{
#ifdef UNIX
  return (((u8*)ptr)[3]<<24)|(((u8*)ptr)[2]<<16)|(((u8*)ptr)[1]<<8)|((u8*)ptr)[0];
#else
...
FORCEINLINE s32 CORRECT_ENDIAN_S32(void *ptr)
{
  return (s32)CORRECT_ENDIAN_U32(ptr);
}

FORCEINLINE u32 MANUAL_ENDIAN_U32(void *ptr)
{
#ifdef UNIX
  return (((u8*)ptr)[0]<<24)|(((u8*)ptr)[1]<<16)|(((u8*)ptr)[2]<<8)|((u8*)ptr)[3];
#else
  return *(u32*)ptr;
#endif
}

FORCEINLINE s32 MANUAL_ENDIAN_S32(void *ptr)
{
  return (s32)MANUAL_ENDIAN_U32(ptr);
}
