	...
	while (!exitLife) {
		...
		processOpcode:
			...
			switch (opcodeLocated) {
				...
				case LM_DO_REAL_ZV:
				{
					appendFormatted("LM_DO_REAL_ZV ");
					doRealZv(currentProcessedActorPtr);
					break;
				}
				case LM_DEF_ZV: // DEF_ZV
				{
					appendFormatted("LM_DEF_ZV ");
				...
				{
					appendFormatted("LM_DO_CARRE_ZV ");
				...
				{
					appendFormatted("LM_GET_HARD_CLIP ");
					getHardClip();
					break;
				}
				////////////////////////////////////////////////////////////////////////
				...
				case LM_ANIM_REPEAT:
				{
					appendFormatted("LM_ANIM_REPEAT ");
					lifeTempVar1 = readNextArgument("Anim");
				...
				case LM_ANIM_ALL_ONCE:
				{
					appendFormatted("LM_ANIM_ALL_ONCE ");
					lifeTempVar1 = readNextArgument("Anim");
					lifeTempVar2 = readNextArgument("Flags");
				...
				{
					appendFormatted("LM_ANIM_HYBRIDE_ONCE ");
					// TODO
					int anim = readNextArgument("Anim");
				...
				{
					appendFormatted("LM_ANIM_HYBRIDE_REPEAT ");
					// TODO
					int anim = readNextArgument("Anim");
					int body = readNextArgument("Body?");
				...
				{
					appendFormatted("LM_STOP_HIT_OBJECT ");
				...
				{
					appendFormatted("LM_RESET_MOVE_MANUAL ");
					resetRotateParam();
					break;
				}
				case LM_CONTINUE_TRACK:
				{
					appendFormatted("LM_CONTINUE_TRACK ");
					char* ptr;
				...
				{
					appendFormatted("LM_START_CHRONO ");
				...
				{
					appendFormatted("LM_FOUND_WEIGHT ");
				...
				{
					appendFormatted("LM_READ_ON_PICTURE ");
					lifeTempVar1 = *(s16*)(currentLifePtr);
					currentLifePtr += 2;
					lifeTempVar2 = *(s16*)(currentLifePtr);
					currentLifePtr += 2;
				...
				{
					appendFormatted("LM_ANIM_SAMPLE ");
					lifeTempVar1 = evalVar();
				...
				{
					appendFormatted("LM_SAMPLE_THEN_REPEAT ");
					playSound(evalVar());
				...
				{
					appendFormatted("LM_CAMERA_TARGET ");
				...
				{
					appendFormatted("LM_MESSAGE_VALUE ");
					lifeTempVar1 = *(s16*)(currentLifePtr);
					currentLifePtr += 2;
				...
				{
					appendFormatted("LM_SWITCH ");
					switchVal = evalVar("value");
					break;
				}
				case LM_CASE: // CASE
				{
					appendFormatted("LM_CASE ");
				...
				case LM_RETURN:
				{
					appendFormatted("LM_RETURN ");
					exitLife = 1;
					break;
				}
				case LM_END:
				{
					appendFormatted("LM_END ");
					exitLife = 1;
					break;
				}
				case LM_GAME_OVER:
				{
					appendFormatted("LM_GAME_OVER ");
					fadeMusic(0, 0, 0x8000);    // fade out music
				...
				{
					appendFormatted("LM_WAIT_GAME_OVER ");
				...
				{
					appendFormatted("LM_CALL_INVENTORY ");
					processInventory();
					break;
				}
				case LM_DO_ROT_CLUT: // DO_ROT_CLUT
				{
					appendFormatted("LM_DO_ROT_CLUT ");
					assert(g_gameId == TIMEGATE);
				...
				{
					appendFormatted("LM_START_FADE_IN_MUSIC_LOOP ");
					assert(g_gameId == TIMEGATE);
